    ...
    return (registerIsEnd ?
            ...
            <div className="register-form">
                ...
                <div className="register-form__data_warning">
                    ...
                    <br/>
                    <br/>
                    Квест будет доступен на этой странице с 1 по 5 июля. Доступ будет предоставлен после ввода номера телефона и пароля, пожалуйста не забудьте пароль.
                    <br/><br/><a href="https://a.goquest.online">На главную</a>
                </div>
            </div>
    );
}
